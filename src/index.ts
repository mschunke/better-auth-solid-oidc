...
import { getOAuthCallbackPath } from "better-auth/oauth2";
import {
 ...
 *
 * Sign-in goes through the standard `signIn.social({ provider })` endpoint. The
 * companion {@link solidOidcClient} client plugin is optional and only adds
 * typed access to the Client Identifier Document endpoint.
 *
